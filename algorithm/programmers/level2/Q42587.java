...
/**
 * <a href="https://school.programmers.co.kr/learn/courses/30/lessons/42587?language=java">...</a>
 * # 프로세스 : 스택/큐
 *
 * 문제 설명
...
public class Q42587 {
    ...
    public static void main(String[] args) {
        new Q42587().solution(new int[]{2, 1, 3, 2}, 2);
        new Q42587().solution(new int[]{1, 1, 9, 1, 1, 1}, 0);
    }
}
